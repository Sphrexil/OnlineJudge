...
public class SubmissionServiceImpl extends ServiceImpl<SubmissionDao, SubmissionStatusEntity> implements SubmissionService {
    ...
    public ResponseResult submit(SubmissionStatusEntity submission) {
        ...
        ResponseResult finalResult = new DefaultRedisLockSupport(SubmissionConstant.SUBMIT_LOCK + "::" + UUID.randomUUID(),
                ...
                .exec(item -> {
                    ...
                    try {
                        ...
                        boolean flag = submissionSource.submissionOutput().send(MessageBuilder.withPayload(submissionDto).setHeader(GlobalConstant.SUBMIT_UNIQUE_TOKEN, uuid)
